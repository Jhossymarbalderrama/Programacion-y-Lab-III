...
{% block content %}
        ...
        <?php           
             require '../scaloneta/vendor/autoload.php';
        ?>
    ...
    <div class="container-fluid" style="margin-top: 150px;">
        <div class="row" id="divResultado">
            <div class="col-sm-6 bg-danger d-block" style="height: auto;" id="divIzq"><h1>izquierda</h1></div>
            <div class= "col-sm-6 bg-success d-block" style="height: auto;" id="divDer"><h1>derecha</h1></div>
        </div>
    </div>
    ...
    <div class="modal" id="ventana_modal_auto">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title text-white">AUTOS - BD</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body bg-light">
                    <p id="cuerpo_modal_auto">Cuerpo...</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal" id="ventana_modal_usuario">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title text-white">Usuarios - BD</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body bg-light">
                    <p id="cuerpo_modal_auto">Cuerpo...</p>
