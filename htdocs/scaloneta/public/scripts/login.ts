/// <reference path="../node_modules/@types/jquery/index.d.ts"/>
    ...
    function IrRegistro():void{
        ...
        $.ajax({
            type: 'GET',
            url: APIREST + "/front-end-registro",
            async: true
        })
        .done(function (resultado: any){
            $(location).attr('href',APIREST + "front-end-registro");
    ...
    function Login(e:Event):void
    {
        ...
        .done(function (resultado: any){
            ...
            if(resultado.exito){
                ...
                $(location).attr('href',APIREST + "front-end-principal");        
               /*  let datosUsuatrio : any = resultado.usuario;                
                alert(datosUsuatrio); */
            }else{
