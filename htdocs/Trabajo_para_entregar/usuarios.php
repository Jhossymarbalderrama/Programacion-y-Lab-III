<?php
    class Usuario
    {
        ...
        {    
            ...
            $consulta = $objetoAccesoDato->RetornarConsulta("SELECT * FROM usuarios JOIN");  
        ...
        public static function Login($correo,$clave)
        {
            ...
            $consulta = $objetoAccesoDato->RetornarConsulta("SELECT * FROM `usuarios` JOIN `perfiles` ON usuarios.perfil = perfiles.id WHERE usuarios.correo = '$correo' && usuarios.clave = '$clave'");        
