...
namespace PrimerParcial
{
   ...
   {      
        public static AgregarProductoJSON()
        {
            ...
            let path : string = "./BACKEND/AltaProductoJSON.php";
        ...
        {
            let ajax : Ajax = new Ajax();
            let path = "./BACKEND/ListadoProductosJSON.php";
        ...
        {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/VerificarProductoJSON.php";
        ...
        {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/MostrarCookie.php";
        ...
        {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/AgregarProductoSinFoto.php";
        ...
        {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/ListadoProductosEnvasados.php";
        ...
        {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/EliminarProductoEnvasado.php";
        ...
        {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/ModificarProductoEnvadado.php";
        ...
        public static VerificarProductoEnvsado(): void {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/VerificarProductoEnvasado.php";
        ...
        public static AgregarProductoFoto(): void {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/AgregarProductoEnvasado.php";
        ...
        public static BorrarProductoFoto(json : string): void {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/BorrarProductoEnvasado.php";
            let producto : Entidades.ProductoEnvasado = JSON.parse(json);
        ...
        public static btn_ModificarProductFoto(json : string):void
        {
           ...
           if(producto.pathFoto != null){
            let foto : string = "./BACKEND/"+producto.pathFoto.toString();
        ...
        public static MostrarBorradosJSON(): void {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/MostrarBorradosJSON.php";
        ...
        public static MostrarFotosModificados(): void {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/MostrarFotosDeModificados.php";
        ...
        public static FiltrarListado(): void {
            let ajax : Ajax = new Ajax();
            let path : string = "./BACKEND/FiltrarProductos.php";
            let origen : string = (<HTMLInputElement> document.getElementById("cboOrigen")).value;
