...
(function (PrimerParcial) {
    var Manejadora = /** @class */ (function () {
        ...
        Manejadora.AgregarProductoJSON = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/AltaProductoJSON.php";
        ...
        Manejadora.MostrarProductosJSON = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/ListadoProductosJSON.php";
        ...
        Manejadora.VerificarProductoJSON = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/VerificarProductoJSON.php";
            var nombre = document.getElementById("nombre").value;
            var origen = document.getElementById("cboOrigen").value;
        ...
        Manejadora.MostrarInfoCookie = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/MostrarCookie.php";
            var nombre = document.getElementById("nombre").value;
            var origen = document.getElementById("cboOrigen").value;
            var param = "nombre=" + nombre + "&origen=" + origen;
        ...
        Manejadora.AgregarProductoSinFoto = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/AgregarProductoSinFoto.php";
            var nombre = document.getElementById("nombre").value;
            var origen = document.getElementById("cboOrigen").value;
        ...
        Manejadora.MostrarProductosEnvasados = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/ListadoProductosEnvasados.php";
        ...
        Manejadora.EliminarProducto = function (json) {
            alert("xdNoAnda");
            var ajax = new Ajax();
            var path = "./clases/backend/EliminarProductoEnvasado.php";
        ...
        Manejadora.ModificarProducto = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/ModificarProductoEnvadado.php";
        ...
        Manejadora.VerificarProductoEnvsado = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/VerificarProductoEnvasado.php";
            var nombre = document.getElementById("nombre").value;
            var origen = document.getElementById("cboOrigen").value;
            var form = new FormData();
        ...
        Manejadora.AgregarProductoFoto = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/AgregarProductoEnvasado.php";
        ...
        Manejadora.BorrarProductoFoto = function (json) {
            var ajax = new Ajax();
            var path = "./clases/backend/BorrarProductoEnvasado.php";
            var producto = JSON.parse(json);
            var nombre = producto.nombre;
        ...
        Manejadora.btn_ModificarProductFoto = function (json) {
            var producto = JSON.parse(json);
            if (producto.pathFoto != null) {
                var foto = "clases/backend/" + producto.pathFoto.toString();
        ...
        Manejadora.MostrarBorradosJSON = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/MostrarBorradosJSON.php";
        ...
        Manejadora.MostrarFotosModificados = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/MostrarFotosDeModificados.php";
        ...
        Manejadora.FiltrarListado = function () {
            var ajax = new Ajax();
            var path = "./clases/backend/FiltrarProductos.php";
            var origen = document.getElementById("cboOrigen").value;
            var form = new FormData();
            form.append("origen", origen);
